...
* **Objective:** Create a visual resource to help peers understand digital literacy.
* **Tool Used:** Canva
...
* **Objective:** Build familiarity with coding practice tools and cloud collaboration.
* **Task:** Completed a beginner challenge on a coding platform and designed a 5-question awareness quiz].
...
* **Objective:** Practice professional communication and social media responsibility].
...
* **Objective:** Research and prevent online threats like UPI fraud.
* **Summary:** A case study on UPI payment scams and an 8-step "Stay Safe Online" prevention guide.
...
* `task-1-presentation/`: The infographic visual.
* `task-2-portfolio/`: Screenshots of professional platform profiles.
* `task-3-platforms/`: Coding challenge proof and form screenshots.
